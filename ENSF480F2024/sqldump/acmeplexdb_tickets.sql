...
CREATE TABLE `tickets` (
  ...
  `ReceiptID` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`TicketID`),
  KEY `MovieName` (`MovieName`),
  KEY `SeatID` (`SeatID`),
  KEY `CustomerUsername` (`CustomerUsername`),
  CONSTRAINT `tickets_ibfk_1` FOREIGN KEY (`MovieName`) REFERENCES `movies` (`MovieTitle`),
  CONSTRAINT `tickets_ibfk_2` FOREIGN KEY (`SeatID`) REFERENCES `seats` (`SeatID`),
  CONSTRAINT `tickets_ibfk_3` FOREIGN KEY (`CustomerUsername`) REFERENCES `customers` (`CUsername`)
